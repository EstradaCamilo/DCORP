    ...
    <div class="card-character-marvel group">
        ...
        <div class="card-character-marvel--content">
            ...
            <div class="h-40 w-40 mx-auto flex flex-col items-center relative">
                <img class="h-full w-full absolute top-0 bottom-0 left-0 right-0 m-auto group-hover:animate-spin-slow" src="~/assets/images/circle.svg"
                    alt="circle">
...
.card-character-marvel {
    @apply relative rounded-md min-h-[370px] border border-grey-300 border-opacity-50 cursor-pointer;
