        ...
        <div class="card-character-marvel--content">
            ...
            <div class="flex flex-col space-y-1 items-center">
                ...
                <div class="h-24 w-24 rounded-full bg-primary-100 flex">
                    <NuxtImg :src="`${character.thumbnail.path.replace('http','https')}.${character.thumbnail.extension}`" :format="character.thumbnail.extension" quality="50" class="h-full w-full rounded-full object-cover" :alt="character.name"></NuxtImg>
